...
from .ui.QSpectrogramOptions_ui import Ui_QSpectrogramOptions
...
class QSpectrogramOptions(QOptionsWidget, Ui_QSpectrogramOptions):
    ...
    def map_update_ui_functions(self):
        res = {"to_db": partial(self.update_checkbox, self.cb_todb),
               ...
               "scale": partial(self.update_combobox, self.combo_scale, SpectrogramOptions.ACCEPTED_VALUES["scale"]),
               "n_fft": partial(self.update_combobox, self.combo_fft, SpectrogramOptions.ACCEPTED_VALUES["n_fft"]),
               "window": partial(self.update_combobox, self.combo_window, SpectrogramOptions.ACCEPTED_VALUES["window"]),
               }
        return res
