...
################################################################################
## Form generated from reading UI file 'QImageOptions.ui'
##
...
class Ui_QImageOptions(object):
    def setupUi(self, QImageOptions):
        if QImageOptions.objectName():
            QImageOptions.setObjectName(u"QImageOptions")
        QImageOptions.resize(400, 160)
        self.gridLayout = QGridLayout(QImageOptions)
        self.gridLayout.setObjectName(u"gridLayout")
        self.label_33 = QLabel(QImageOptions)
        ...
        self.combo_color_map = QComboBox(QImageOptions)
        ...
        self.label_36 = QLabel(QImageOptions)
        ...
        self.slider_contrast = QSlider(QImageOptions)
        ...
        self.label_35 = QLabel(QImageOptions)
        ...
        self.spin_pix_in_sec = QSpinBox(QImageOptions)
        ...
        self.label_34 = QLabel(QImageOptions)
        self.label_34.setObjectName(u"label_34")

        self.gridLayout.addWidget(self.label_34, 3, 0, 1, 1)

        self.spin_height = QSpinBox(QImageOptions)
        ...
        self.cb_invert_colors = QCheckBox(QImageOptions)
        self.cb_invert_colors.setObjectName(u"cb_invert_colors")

        self.gridLayout.addWidget(self.cb_invert_colors, 4, 0, 1, 1)


        self.retranslateUi(QImageOptions)

        QMetaObject.connectSlotsByName(QImageOptions)
    # setupUi

    def retranslateUi(self, QImageOptions):
        QImageOptions.setWindowTitle(QCoreApplication.translate("QImageOptions", u"Form", None))
        self.label_33.setText(QCoreApplication.translate("QImageOptions", u"Color map", None))
        self.label_36.setText(QCoreApplication.translate("QImageOptions", u"Color contrast", None))
        self.label_35.setText(QCoreApplication.translate("QImageOptions", u"Number of pixels in a second", None))
        self.label_34.setText(QCoreApplication.translate("QImageOptions", u"Height", None))
        self.cb_invert_colors.setText(QCoreApplication.translate("QImageOptions", u"Invert colors", None))
    # retranslateUi
