...
#
# Created: Wed Jan 29 16:50:35 2020
...
class Ui_QSoundPlayer(object):
    def setupUi(self, QSoundPlayer):
        ...
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.btn_seek.sizePolicy().hasHeightForWidth())
    ...
    def retranslateUi(self, QSoundPlayer):
        QSoundPlayer.setWindowTitle(QtWidgets.QApplication.translate("QSoundPlayer", "Form", None, -1))
        self.btn_stop.setToolTip(QtWidgets.QApplication.translate("QSoundPlayer", "Stop", None, -1))
        self.btn_play.setToolTip(QtWidgets.QApplication.translate("QSoundPlayer", "Play", None, -1))
        self.btn_seek.setToolTip(QtWidgets.QApplication.translate("QSoundPlayer", "Seek", None, -1))
        self.label.setText(QtWidgets.QApplication.translate("QSoundPlayer", "playback speed:", None, -1))

from qwidgets_extra.QJumpSlider import QJumpSlider
